...
echo "wget -q \"http://www.cse.iitd.ac.in/~pranshu/SVM/test_private.csv\"" >> vpl_execution
echo "wget -q \"http://www.cse.iitd.ac.in/~pranshu/SVM/private_labels.txt\"" >> vpl_execution
...
echo "python3 -W ignore svm.py train.csv test_private.csv testpred.txt">> vpl_execution
echo "python3 -W ignore grade.py testpred.txt private_labels.txt" >> vpl_execution
